...
class LearnDMPFromDemoRequest(genpy.Message):
  ...
  _full_text = """# Provide a demonstration traj 
DMPTraj demo
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.demo.times))
      length = len(self.k_gains)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.k_gains))
      length = len(self.d_gains)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.d_gains))
      _x = self.num_bases
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.demo.times = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.k_gains = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.d_gains = s.unpack(str[start:end])
      start = end
      end += 4
