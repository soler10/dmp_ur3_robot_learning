...
struct DMPData_
{
  ...
  _weights_type weights;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _f_domain_type;
  _f_domain_type f_domain;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _f_targets_type;
...
bool operator==(const ::dmp::DMPData_<ContainerAllocator1> & lhs, const ::dmp::DMPData_<ContainerAllocator2> & rhs)
{
  return lhs.k_gain == rhs.k_gain &&
    lhs.d_gain == rhs.d_gain &&
    lhs.weights == rhs.weights &&
    lhs.f_domain == rhs.f_domain &&
    lhs.f_targets == rhs.f_targets;
}
