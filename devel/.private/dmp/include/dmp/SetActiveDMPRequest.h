...
bool operator==(const ::dmp::SetActiveDMPRequest_<ContainerAllocator1> & lhs, const ::dmp::SetActiveDMPRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::dmp::SetActiveDMPRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Input a DMP for each DOF, which will be linked together with a single phase variable\n"
"DMPData[] dmp_list\n"
"\n"
"\n"
"================================================================================\n"
